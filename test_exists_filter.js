...
async function testExistsFilter() {
  try {
    ...
    // Set filter to check if messages text body exists (operator: exists)
    mod2.filter = {
    ...
    console.log("Patching scenario with exists filter on message body...");
                ...
                messages: [
                  {
                    ...
                    text: { body: "Hola, probando con filtro de body exists" },
                    type: "text"
                  }
                ]
              },
