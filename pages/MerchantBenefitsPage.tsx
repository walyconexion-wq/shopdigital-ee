...
interface BenefitCard {
    id: string;
    type: 'descuento' | 'servicio' | 'oferta';
    category: string;
...
// ─────────────────────────────────────────────
// DATOS DE MUESTRA — 24 beneficios para Comercios (B2B + Comerciales)
// ─────────────────────────────────────────────
const SAMPLE_BENEFITS: BenefitCard[] = [
    {
        ...
        brand: 'Distribuidora El Sol',
        title: '15% off en tu compra mayorista',
        description: 'Descuento exclusivo en tu primer pedido de reposición de mercadería. Compra mínima $50.000.',
        discount: '15%',
    ...
    },
    {
        ...
        brand: 'PackExpress',
        title: 'Rollos de film y bolsas 20% off',
        description: 'Descuento directo en insumos de empaque y bolsas de consorcio o delivery. Presentá tu credencial.',
        discount: '-20%',
        code: 'COMERCIO-PACK-20',
    ...
    },
    {
        ...
        brand: 'Posnet Point',
        title: 'Lector Point Smart con 30% off',
        description: 'Adquirí tu terminal inteligente con tarifa preferencial + 3 meses de abono bonificado al 100%.',
        discount: '30%',
    ...
    },
    {
        ...
        brand: 'ClimaTek Central',
        title: 'Service de refrigeración 20% off',
        description: 'Mantenimiento preventivo y service de heladeras comerciales, cámaras, exhibidoras y aire acondicionado.',
        discount: '-20%',
        code: 'COMERCIO-SERVICE',
    ...
    },
    {
        ...
        brand: 'La Caja Comercios',
        title: '15% off Seguro Integral',
        description: 'Protección integral y asesoramiento contra robo, incendio y responsabilidad civil. Descuento en las primeras 6 cuotas.',
        discount: '15%',
    ...
    },
    {
        ...
        brand: 'Sur Imprime',
        title: '1000 folletos o stickers QR',
        description: 'Diseño e impresión de folletería publicitaria o stickers con tu QR de ShopDigital. Entrega sin cargo.',
        discount: '30%',
        validUntil: '31 Jul 2025',
    ...
    },
    {
        ...
        brand: 'Envíos Ya',
        title: 'Pack 10 envíos locales gratis',
        description: 'Despachá tus ventas a domicilio en el día. Servicio bonificado de envíos para probar la plataforma logística.',
        discount: 'Gratis',
        code: 'COMERCIO-DELIVERY',
    ...
    },
    {
        ...
        brand: 'Bebidas Sur',
        title: 'Bonificación en tu 1er pedido',
        description: 'Descuento especial en cajones y packs cerrados de gaseosas y cervezas. Exclusivo para almacenes y gastronomía.',
        discount: '10%',
    ...
    },
    {
        ...
        brand: 'Luz & Fuerza Eléctrica',
        title: 'Instalaciones y electricistas',
        description: 'Servicio de instalación de luminaria comercial y adecuación de tableros eléctricos. Presupuesto sin cargo.',
        discount: '15%',
        validUntil: '15 Ago 2025',
    ...
    },
    {
        ...
        brand: 'Gráfica Central',
        title: 'Cartelería y marquesinas 25% off',
        description: 'Renová la fachada de tu local. Servicio de impresión en lona frontlight y colocación de gigantografías.',
        discount: '25%',
        code: 'COMERCIO-QR-30',
        validUntil: '31 Ago 2025',
    ...
    },
    {
        ...
        brand: 'LimpMax Mayorista',
        title: '25% off en bidones de limpieza',
        description: 'Lavandina, desinfectantes, detergente y jabón líquido en bidones de 5L. Envío gratis a tu local.',
        discount: '25%',
        validUntil: 'Indefinido',
    ...
    },
    {
        ...
        brand: 'Papelera Central',
        title: 'Rollos ticket fiscal e insumos',
        description: 'Caja de 50 rollos térmicos para ticketeadoras fiscales, resmas A4 y artículos de librería de oficina.',
        discount: '-15%',
        code: 'COMERCIO-TICKET-15',
        validUntil: '30 Sep 2025',
        image: 'https://images.unsplash.com/photo-1586075010923-2dd4570fb338?w=600&q=80',
    },
    // Beneficios VIP adaptados para la red comercial B2B
    {
        id: 'mb13',
        type: 'descuento',
        category: 'Pizzerías',
        ...
        description: 'Pizza artesanal a la piedra. Presentá tu credencial de Comercio y llevate el 30% de descuento en cualquier pizza grande.',
        discount: '30%',
        validUntil: '31 Jul 2025',
    ...
    },
    {
        ...
        categoryColor: '#a855f7',
        brand: 'CrediPyme',
        title: 'Préstamos Pyme tasa fija',
        description: 'Crédito de financiación y préstamos de capital de trabajo a tasa preferencial para comercios. Desembolso rápido.',
        discount: 'Tasa Fija',
        code: 'COMERCIO-PRESTAMO',
        validUntil: '30 Jun 2025',
    ...
    },
    {
        ...
        description: 'Primera quincena gratis + 25% de descuento en inscripción comercial. Incluye sala de musculación.',
        discount: '25%',
        validUntil: 'Indefinido',
    ...
    },
    {
        ...
        categoryColor: '#ec4899',
        brand: 'Asesores Pyme',
        title: 'Primera consulta legal 100% off',
        description: 'Asesoramiento de abogados especializado en derecho comercial, contratos de alquiler de local, y defensa del consumidor.',
        discount: 'Gratis',
        code: 'COMERCIO-ABOGADO',
        validUntil: '15 Jul 2025',
    ...
    },
    {
        ...
        description: 'Descuento en toda la colección otoño-invierno. Ropa corporativa, uniformes y prendas de abrigo.',
        discount: '20%',
        validUntil: '31 Ago 2025',
    ...
    },
    {
        ...
        description: 'Tratamiento facial completo. Primera vez 50% off para dueños y empleados de comercios de la red.',
        discount: '50%',
    ...
    },
    {
        ...
        categoryIcon: Wrench,
        categoryColor: '#6366f1',
        brand: 'Pinturas Integrales',
        title: '20% off mano de obra pintores',
        description: 'Renová el interior o exterior de tu local comercial. Servicio de pintores profesionales con seguro de accidentes.',
        discount: '20%',
        code: 'COMERCIO-PINTOR',
        validUntil: '10 Jul 2025',
    ...
    },
    {
        ...
        description: 'Precio especial para dueños de local: $29.900 (precio normal $38.000). Incluye maletín y garantía.',
        discount: '-$8.100',
        validUntil: '30 Jun 2025',
        image: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=600&q=80',
    },
    {
        ...
        description: 'Service completo con aceite Castrol premium. Servicio de revisión de frenos, suspensión y luces.',
        discount: '25%',
        code: 'COMERCIO-CAR-OIL',
        validUntil: '31 Jul 2025',
        image: 'https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=600&q=80',
        badge: 'Solo Comercios'
    },
    {
        id: 'mb23',
        type: 'descuento',
        ...
        description: 'Hamburguesa artesanal doble, papas crocantes y bebida a elección. Precio VIP comercial.',
        discount: '15%',
        validUntil: 'Indefinido',
    ...
    },
    {
        ...
        description: 'Vacuna séxtuple + antirábica. Servicio veterinario a precio especial para red comercial.',
        discount: '-$2.500',
        code: 'COMERCIO-PET-VAC',
        validUntil: '31 Ago 2025',
...
const TYPES = ['descuento', 'servicio', 'oferta'];
...
const BenefitCardComponent: React.FC<{ benefit: BenefitCard; idx: number; isDayMode: boolean }> = ({ benefit, idx, isDayMode }) => {
    ...
    const handleShare = () => {
        playNeonClick();
        const text = `💼 *Beneficio de Comercio B2B: ${benefit.discount} en ${benefit.brand}*\n${benefit.title}\n\n${benefit.description}\n\n✅ Válido hasta: ${benefit.validUntil}\n🔗 Ver beneficios de Comercios Asociados: ${window.location.href}`;
        if (navigator.share) {
    ...
    const typeLabel = { descuento: '🏷️ DESCUENTO B2B', servicio: '🛠️ SERVICIO B2B', oferta: '⚡ OFERTA B2B' }[benefit.type];
        ...
        <div
            className={`group border rounded-[2.5rem] overflow-hidden shadow-2xl transition-all duration-300 ${
                isDayMode
                    ...
                    : 'bg-[#0e1726]/40 backdrop-blur-xl border-amber-500/20 border-b-[8px] border-b-amber-500 shadow-amber-950/20 hover:shadow-[0_0_20px_rgba(245,158,11,0.15)]'
            }`}
            ...
            <div className="p-5 pt-3">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        onClick={() => {
                            playNeonClick();
                            alert("Presentá tu Credencial de Comercio Asociado de ShopDigital ante el proveedor para activar este beneficio B2B 💼");
                        }}
                    ...
                    >
                        ...
                        <span className="text-[8px] font-black uppercase tracking-widest text-inherit">Credencial Comercio</span>
                    </button>
...
// MAIN PAGE
// ─────────────────────────────────────────────
const MerchantBenefitsPage: React.FC = () => {
    ...
    const stats = useMemo(() => ({
        ...
        servicios: SAMPLE_BENEFITS.filter(b => b.type === 'servicio').length,
        ofertas: SAMPLE_BENEFITS.filter(b => b.type === 'oferta').length,
    }), []);

    const handleShare = () => {
        playNeonClick();
        const text = `💼 ¡Beneficios para Comercios Asociados en ShopDigital!\n\n${stats.total} descuentos, ofertas y servicios para locales 🎁\n\n👉 ${window.location.href}`;
        if (navigator.share) {
            navigator.share({ title: 'Beneficios B2B · ShopDigital', text, url: window.location.href }).catch(console.error);
        } else {
            window.open(`https://wa.me/?text=${encodeURIComponent(text)}`, '_blank');
        }
    };
    ...
    const ariContextShop = {
        ...
        category: 'Comercios Asociados',
        slug: 'shopdigital-b2b',
        address: 'Argentina',
        phone: '1140607059',
        description: 'Red B2B de Comercios Asociados de Argentina',
        rating: 5,
        isActive: true,
        offers: [],
        visits: 0,
    ...
    return (
        ...
        >
            ...
            <main className="relative z-10 flex flex-col items-center w-full max-w-lg mx-auto pt-4 px-4">
                ...
                {/* HERO CARD & ARI DIALOGUE (Template Mold style) */}
                <div className="w-full mt-2">
                    <div className={`border border-b-[6px] p-6 rounded-[2.5rem] shadow-lg flex flex-col items-center gap-5 text-center relative overflow-hidden transition-all duration-700 ${
                        isDayMode 
                            ...
                            : 'bg-[#0e1726]/40 backdrop-blur-xl border-amber-500/20 border-b-amber-500 shadow-amber-950/20'
                    }`}>
                        {/* Zone Badge */}
                        ...
                        <div className={`absolute top-0 right-0 text-[7px] font-[1000] uppercase tracking-[0.25em] px-4 py-1.5 rounded-bl-2xl transition-colors duration-500 ${
                            isDayMode ? 'bg-[#2d1e15] text-[#faf8f5]' : 'bg-amber-400 text-black font-black shadow-[0_0_10px_#f59e0b]'
                        }`}>
                            SOCIOS B2B 💼
                        </div>
                        ...
                        <div className="flex justify-center mt-2">
                            <div className={`flex items-center gap-2 border rounded-full px-4 py-1.5 ${
                                ...
                                <span className="text-[9px] font-black uppercase tracking-[0.4em]">Comercios Asociados</span>
                                <Star size={10} className="text-amber-500 fill-amber-500 animate-spin-slow" />
                            </div>
                        </div>
                        ...
                        <h1 className="text-[24px] font-[1100] tracking-tighter leading-none uppercase">
                            Beneficios B2B <br />
                            <span className={isDayMode ? 'text-[#855b3c]' : 'text-amber-400 text-shadow-premium'}>Para Tu Local</span>
                        </h1>
                        ...
                        <div className={`rounded-2xl py-2.5 px-4 relative max-w-[90%] border transition-colors duration-500 ${
                            ...
                            <p className="text-[10px] leading-normal font-bold tracking-tight">
                                "¡Hola! Soy <strong className="text-[#22d3ee]">Ari</strong>, tu asistente comercial. Encontrá los beneficios exclusivos para tu negocio aquí. Filtrá por rubro y activalos presentando tu credencial de Comercio Asociado 💙"
                            </p>
                        </div>
                        ...
                        <div className="relative w-32 h-32 flex-shrink-0 animate-bounce-slow">
                            <div className={`absolute inset-0 rounded-full blur-xl animate-pulse ${
                                isDayMode ? 'bg-amber-400/10' : 'bg-amber-500/20'
                            }`} />
                            <img 
                ...
                {/* FILTER SECTION (VIP template styles applied to B2B) */}
                <div className={`w-full mt-4 border border-b-[5px] p-4 rounded-[2rem] shadow-md transition-all duration-700 ${
                    isDayMode 
                        ? 'bg-[#faf8f5] border-slate-200 border-b-[#855b3c]' 
                        : 'bg-[#0e1726]/40 backdrop-blur-xl border-amber-500/20 border-b-amber-500 shadow-amber-950/20'
                }`}>
                    <p className={`text-[9.5px] font-[1000] uppercase tracking-wider mb-2.5 ${isDayMode ? 'text-[#2d1e15]/60' : 'text-amber-400/85'}`}>Filtrar Beneficios</p>
                ...
                <div className="w-full flex flex-col gap-4">
                    {filtered.length === 0 ? (
                        <div className={`border border-b-[5px] rounded-[2.5rem] p-12 flex flex-col items-center gap-3 text-center transition-all duration-700 ${
                            ...
                            <p className={`text-[10px] uppercase tracking-widest font-black ${isDayMode ? 'text-[#2d1e15]/40' : 'text-white/30'}`}>No hay beneficios B2B en esta categoría</p>
                            <button onClick={() => { setActiveCategory('Todos'); setActiveType('Todos'); playNeonClick(); }} className={`px-6 py-3 rounded-xl border border-b-[4px] text-[10px] font-black uppercase tracking-widest flex items-center gap-2 transition-all hover:translate-y-[-1px] hover:border-b-[5px] active:translate-y-[3px] active:border-b-[1px] ${
                                isDayMode 
                                    ...
                                    : 'bg-white/5 border-white/10 border-b-white/20 text-amber-400'
                            }`}>
                ...
                {/* FOOTER CTA & CONTROLS (Swapped order matching VIP mold) */}
                <div className="w-full mt-6 flex flex-col gap-3">
                    ...
                    {/* Speak to advisor/Info block (Placed below Regresar al inicio) */}
                    <div className={`border border-b-[5px] p-5 rounded-[2rem] flex items-start gap-4 transition-colors duration-300 ${
                        ...
                        <div>
                            <p className={`text-[9px] font-black uppercase tracking-widest mb-1 ${isDayMode ? 'text-amber-700' : 'text-amber-400'}`}>Ari dice</p>
                            <p className={`text-[10px] font-medium leading-relaxed ${isDayMode ? 'text-[#2d1e15]/60' : 'text-white/50'}`}>
                                Para validar estos beneficios B2B con tu distribuidor o proveedor, recordá mostrar tu <span className={isDayMode ? 'text-amber-700 font-bold' : 'text-amber-400 font-bold'}>Credencial de Comercio Asociado</span> 📱 ¡Hagamos crecer tu local!
                            </p>
                        </div>
                    </div>
                </div>
...
export default MerchantBenefitsPage;
