            ...
            <div className="sticky top-0 z-40 bg-[#020617]/80 backdrop-blur-xl border-b border-emerald-500/20 pt-6 pb-4 px-6 shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex-1 flex justify-center items-center gap-3">
                        <div className="w-10 h-10 bg-emerald-500/10 rounded-xl flex items-center justify-center border border-emerald-500/30" style={{ animation: 'pulseGlowEmerald 3s infinite' }}>
