...
const Home: React.FC = () => {
    ...
    const injectTestShops = async () => {
        ...
        alert("Restaurantes subidos con exito a Firebase");
    };
    ...
    return (
        <div className="flex flex-col pt-8 pb-12 animate-in fade-in duration-700 relative overflow-hidden min-h-screen bg-transparent">
            ...
            <div className="flex flex-col items-center mb-10 mt-3 fade-up-item relative z-10 px-6">
                ...
                <button id="inject-shops-btn" onClick={injectTestShops} className="bg-red-500 text-white p-2 mt-4 rounded z-50 relative">INJECT DATA</button>
