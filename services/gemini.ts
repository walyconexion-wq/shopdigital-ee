...
export const generateAriResponse = async (history: { role: 'director'|'ari', text: string }[], systemContext?: string) => {
    ...
    let systemPrompt = `Sos ARI (Analista de Red de Inteligencia), la mano derecha del Director "Waly" en "Shop Digital". 
...
Responde conciso, con vinetas si es necesario. No repitas el contexto ciegamente, usalo para darle riqueza a la charla.`;
