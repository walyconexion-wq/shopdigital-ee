  ...
  return (
    <div className="flex flex-col items-center justify-center pt-2 pb-2 px-6 select-none text-center">
      ...
      <div className="flex justify-center mb-1">
        <svg width="60" height="45" viewBox="0 0 100 80" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <p className="text-[8px] font-black text-[#0A224E]/40 tracking-[0.3em] uppercase mt-2">
