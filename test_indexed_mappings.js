...
async function testIndexedMappings() {
  try {
    ...
    // Update text input to use [1] indexes
    ...
    mod2.filter = {
      ...
      conditions: [
        [
          {
            a: "{{1.entry[1].changes[1].value.messages[1].text.body}}",
            o: "exists"
          }
        ]
      ]
    ...
    // 3. Find Module 5 and update its `to` mapper using [1] indexes
    ...
    console.log("Patching scenario with indexed mappings...");
                ...
                messages: [
                  {
                    ...
                    text: { body: "Hola, este es un mensaje de prueba con indexacion" },
                    type: "text"
                  }
                ]
              },
